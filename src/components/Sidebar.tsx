...
export default function Sidebar() {
  ...
  const links = [
    ...
    { to: '/monitor', icon: Eye, label: 'Company Monitor', badge: 'OSINT' },
    { to: '/config', icon: Settings2, label: 'Config' },
    { to: '/prompts', icon: FileCode, label: 'OSINT Prompts' },
    { to: '/unknown-questions', icon: BookOpen, label: 'Knowledge' },
    { to: '/logs', icon: ScrollText, label: 'Research Runs', badge: 'BETA' },
